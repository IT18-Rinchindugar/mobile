...
const theme = {
  colors: {
    ...
    newIce: palette.newIce,
    newGreen: palette.newGreen,
    newRed: palette.newRed,
    newDisabledGray: palette.newDisabledGray,
    newTextGray: palette.newTextGray,
